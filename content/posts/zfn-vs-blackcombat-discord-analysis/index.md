...
category: "컬럼"
date: "2026-05-20"
excerpt: "최근 최준서의 이적과 템퍼링 논란으로 촉발된 ZFN(정찬성)과 블랙컴뱃(검정)의 대립. 정통 스포츠의 자부심과 뉴미디어 서사의 야심이 충돌하는 대한민국 MMA 씬의 구조적 갈등과 공존의 가능성을 입체적으로 해부한다."
tags: ["ZFN", "블랙컴뱃", "정찬성", "검정", "최준서", "국내MMA", "격투기칼럼"]
---
...
먼저 **ZFN**의 본질은 **'UFC로 통하는 공식 파이프라인'**이다. 정찬성 대표의 강력한 글로벌 네트워크와 상징 자본을 바탕으로 설립된 이 단체는 철저히 **스포츠적 완성도**에 목을 맨다. 대회가 **UFC 파이트 패스(UFC Fight Pass)**를 통해 전 세계로 송출된다는 사실은 ZFN의 정체성을 단적으로 말해준다. ZFN에 서는 선수들은 스토리를 팔지 않아도 된다. 오직 케이지 안에서 완벽한 **레벨 체인지**와 정밀한 **체크훅**, 견고한 **카프킥** 공방을 통해 본인의 경기력을 증명하면 된다. ZFN은 '진짜 격투기 무대'를 제공하며, 실력을 검증받은 파이터를 해외 대형 단체로 수출하는 **엘리트 육성 플랫폼**의 역할을 자임한다.

- **ZFN의 핵심 전략**: 글로벌 스탠다드의 경기력, 정통 스포츠 지향, 해외 파이프라인.
- **ZFN의 강점**: 선수들의 높은 경기력 밀도, 정찬성 브랜드의 대외 신뢰도, 글로벌 중계 플랫폼.
- **ZFN의 약점**: 스토리가 부재한 일반 매치업에서의 대중적 화제성 한계, 높은 제작비 대비 단기 수익 모델의 부재.

반면 **블랙컴뱃**은 **'격투 극장(MMA Drama)'**에 가깝다. 이들은 유튜브라는 강력한 미디어를 메인 플랫폼으로 삼고, 선수의 전적이나 백그라운드보다 **서사(Storytelling)**와 **캐릭터(Character)**를 전면에 내세운다. 블랙컴뱃의 대진은 단순한 랭킹 순이 아니다. 유튜브 콘텐츠 속에서 빚어낸 원한 관계, 도발, 극적인 갈등 구조가 링 위에서 해소되는 형태로 대회가 연출된다. 이들은 격투기를 보지 않던 일반 대중들을 유튜브 조회수를 통해 격투 씬으로 유입시키는 데 가장 뛰어난 성과를 냈다.

- **블랙컴뱃의 핵심 전략**: 뉴미디어 기반 캐릭터 브랜딩, 웹 예능식 서사 빌드업, 팬덤 직접 판매(굿즈, 오프라인 티켓).
- **블랙컴뱃의 강점**: 충성도 높은 거대 팬덤, 폭발적인 조회수와 온라인 화제성, 해외 유수 단체(DEEP 등)와의 교류전을 통한 서사의 확장성.
- **블랙컴뱃의 약점**: 정통 격투 팬들로부터 제기되는 '예능적 연출'과 '경기력 불균형' 비판, 엘리트 파이터 수급의 한계.
...
- **블랙컴뱃의 역할 (대중적 유입 통로)**: 격투기에 전혀 관심이 없던 일반 대중들을 자극적인 캐릭터 서사와 웹 예능 문법을 통해 격투기 생태계 안으로 끌어들인다. 이들은 격투 씬의 '소비자층'을 기하급수적으로 넓히는 전위대 역할을 수행한다.
- **ZFN의 역할 (엘리트 기술의 종착지)**: 유입된 라이트 팬덤이 격투기 자체의 본질적 매력에 매료되었을 때, 이들의 갈증을 채워줄 수 있는 고난도 **레벨 체인지**와 글로벌 수준의 스탠다드 경기를 제공한다. 격투기 매니아층의 깊이를 더해주는 필터 역할을 하는 것이다.

처음에는 블랙컴뱃의 유튜브 드라마에 매료되어 입문한 팬이, 격투기라는 스포츠 자체의 매력에 눈을 떠 ZFN의 정밀한 기술 분석 칼럼을 탐독하게 된다. 반대로 ZFN의 엘리트 스포츠 문법만 고집하던 헤비 매니아층 역시 블랙컴뱃이 선사하는 끈끈한 서사와 감정선에 몰입하게 된다. <mark>즉, 두 단체의 공존은 파이를 갈라 먹는 제로섬 게임이 아니라, 대중성과 전문성이 서로의 고객을 교차 수급하며 시장 전체의 크기를 키우는 강력한 곱셈 정리다.</mark>
...
ZFN의 높은 기술적 규격(UFC 파이트 패스 중계, 국제전 중심의 대진)은 블랙컴뱃에게 **"스토리만 있고 실력은 없다"**는 매니아들의 조롱을 잠재워야 하는 강력한 자극제가 되었다. 실제로 블랙컴뱃은 최근 엘리트 파이터 수급에 열을 올리고 있으며 일본 DEEP 등과의 교류를 통해 경기력 입증에 사력을 다하고 있다. 반대로 블랙컴뱃의 압도적인 유튜브 영향력과 상업적 성공(완판 신화)은 ZFN에게 **"단순 경기력만으로는 대중의 시선을 잡을 수 없다"**는 뼈아픈 교훈을 안겼다. 그 결과 ZFN 역시 언더카드의 유튜브 무료 송출, 볼카노프스키 방한 활용 등 스토리텔링적 요소를 적극적으로 차용하며 변모하기 시작했다. 

> **상대의 장점을 흡수하고 자신의 단점을 보완하려는 이 치열한 '상호 진화의 춤'은 두 단체 모두를 글로벌 시장에서도 통할 만한 고도의 구조로 밀어 올리고 있다.**
